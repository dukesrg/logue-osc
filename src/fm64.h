...
// Op 6  Op 5  Op 4  Op 3  Op 2  Op 1
  {0x40, 0x21, 0x22, 0xA4, 0x00, 0xB0}, //1 = 1 DX11
  {0x00, 0x21, 0x22, 0xA4, 0x44, 0xB0},
  {0x40, 0x21, 0xA2, 0x00, 0x28, 0xB0},
  {0x42, 0x21, 0xA2, 0x00, 0x28, 0xB0},
  {0x40, 0xA1, 0x00, 0xA4, 0x00, 0xB0}, //5 = 5 DX11
  {0x41, 0xA1, 0x00, 0xA4, 0x00, 0xB0},
  {0x40, 0x21, 0x00, 0xA6, 0x00, 0xB0}, //7 = 4 DX11
  {0x00, 0x21, 0x42, 0xA6, 0x00, 0xB0}, //8 ~ 3 DX11
  ...
  {0x40, 0x00, 0x23, 0xA4, 0x00, 0xB0}, //14 = 2 DX11
  ...
  {0x00, 0x00, 0xA3, 0x43, 0xA8, 0xA8}, //20 = 41 SY77
  {0x00, 0xA1, 0xA1, 0x43, 0xA8, 0xA8},
  {0x40, 0xA1, 0xA1, 0xA1, 0x00, 0xB0}, //22 = 6 DX11
  ...
  {0x40, 0xA1, 0x80, 0x80, 0x80, 0x80}, //31 = 7 DX11
  {0xC0, 0x80, 0x80, 0x80, 0x80, 0x80}, //32 = 8 DX11
#ifdef OPSIX
...
#ifdef SY77
  {0x00, 0x21, 0x22, 0x24, 0x28, 0xB0},
  {0x00, 0x00, 0x23, 0x24, 0x28, 0xB0},
  {0x00, 0x00, 0x22, 0x25, 0x28, 0xB0},
  {0x00, 0x00, 0x22, 0x24, 0x29, 0xB0},
  {0x00, 0x21, 0x22, 0x24, 0x28, 0xB1},
  {0x00, 0x00, 0x00, 0x27, 0x28, 0xB0},
  {0x00, 0x21, 0x00, 0x24, 0x2A, 0xB0},
  {0x00, 0x00, 0x00, 0x24, 0x2B, 0xB0},
  {0x00, 0x00, 0x23, 0x00, 0x2C, 0xB0},
  {0x00, 0x21, 0x00, 0x24, 0x28, 0xB2},
  {0x00, 0x00, 0x00, 0x24, 0x28, 0xB3},
  {0x00, 0x00, 0x23, 0x24, 0x00, 0xB8},
  {0x00, 0x00, 0x22, 0x25, 0x00, 0xB8},
  {0x00, 0x00, 0x00, 0x00, 0x2F, 0xB0},
  {0x00, 0x00, 0x00, 0x27, 0x00, 0xB8},
  {0x00, 0x00, 0x22, 0x00, 0x28, 0xB5},
  {0x00, 0x00, 0x23, 0x00, 0x28, 0xB4},
  {0x00, 0x00, 0x00, 0x00, 0x28, 0xB7},
  {0x40, 0x00, 0x00, 0x00, 0x29, 0xB6},
  {0x00, 0x00, 0x00, 0x00, 0x00, 0xBF},
  {0x00, 0x21, 0x22, 0x24, 0xA8, 0x80},
  {0x00, 0x00, 0x23, 0x24, 0xA8, 0x80},
  {0x00, 0x00, 0x22, 0x25, 0xA8, 0x80},
  {0x00, 0x00, 0x22, 0x24, 0xA9, 0x80},
  {0x00, 0x00, 0x00, 0x27, 0xA8, 0x80},
  {0x00, 0x21, 0x00, 0x23, 0xAA, 0x80},
  {0x00, 0x00, 0x00, 0x24, 0xAB, 0x80},
  {0x00, 0x00, 0x23, 0x00, 0xAC, 0x80},
  {0x00, 0x00, 0x00, 0x00, 0xAF, 0x80},
  {0x00, 0x21, 0x22, 0xA4, 0x00, 0xB0},
  {0x00, 0x41, 0x23, 0xA4, 0x00, 0xB0},
  {0x00, 0x00, 0x23, 0xA5, 0x00, 0xB0},
  {0x00, 0x00, 0x00, 0xA7, 0x00, 0xB0},
  {0x00, 0x21, 0xA2, 0x00, 0x28, 0xB0},
  {0x00, 0x00, 0xA3, 0x00, 0x28, 0xB0},
  {0x00, 0x00, 0xA3, 0x43, 0x00, 0xB8},
  {0x00, 0x21, 0x22, 0xA4, 0x80, 0x80},
  {0x00, 0x00, 0x23, 0xA4, 0x80, 0x80},
  {0x00, 0x00, 0x22, 0xA5, 0x80, 0x80},
  {0x00, 0x21, 0xA2, 0x43, 0xA8, 0xA8},
  {0x00, 0x00, 0xA3, 0x43, 0xA8, 0xA8}, //41 = 20 DX7
  {0x40, 0xA1, 0x00, 0xA4, 0x00, 0xB0},
  {0x41, 0x21, 0xA3, 0xA3, 0xA3, 0xA3},
  {0x40, 0xA1, 0xA1, 0xA1, 0xA1, 0xA1},
