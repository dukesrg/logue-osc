...
//  {0b01000000, 0b00100001, 0b00100010, 0b01000100, 0b00000000, 0b10110000}, //1 = 1 DX11
// Op 6  Op 5  Op 4  Op 3  Op 2  Op 1
  {0x20, 0x01, 0x02, 0x84, 0x00, 0x90}, //1 = 1 DX11
  {0x00, 0x01, 0x02, 0x84, 0x24, 0x90},
  {0x20, 0x01, 0x82, 0x00, 0x08, 0x90},
  {0x22, 0x01, 0x82, 0x00, 0x08, 0x90},
  {0x20, 0x81, 0x00, 0x84, 0x00, 0x90}, //5 = 5 DX11
  {0x21, 0x81, 0x00, 0x84, 0x00, 0x90},
  {0x20, 0x01, 0x00, 0x86, 0x00, 0x90}, //7 = 4 DX11
  {0x00, 0x01, 0x22, 0x86, 0x00, 0x90}, //8 ~ 3 DX11
  {0x00, 0x01, 0x00, 0x86, 0x24, 0x90},
  {0x00, 0x00, 0x83, 0x23, 0x08, 0x90},
  {0x20, 0x00, 0x83, 0x00, 0x08, 0x90},
  {0x00, 0x00, 0x00, 0x87, 0x24, 0x90},
  {0x20, 0x00, 0x00, 0x87, 0x00, 0x90},
  {0x20, 0x00, 0x03, 0x84, 0x00, 0x90}, //14 = 2 DX11
  {0x00, 0x00, 0x03, 0x84, 0x24, 0x90},
  {0x20, 0x01, 0x00, 0x04, 0x00, 0x9A},
  {0x00, 0x01, 0x00, 0x04, 0x24, 0x9A},
  {0x00, 0x01, 0x02, 0x23, 0x00, 0x9C},
  {0x20, 0x81, 0x81, 0x00, 0x08, 0x90},
  {0x00, 0x00, 0x83, 0x23, 0x88, 0x88}, //20 = 41 SY77
  {0x00, 0x81, 0x81, 0x23, 0x88, 0x88},
  {0x20, 0x81, 0x81, 0x81, 0x00, 0x90}, //22 = 6 DX11
  {0x20, 0x81, 0x81, 0x00, 0x88, 0x80},
  {0x20, 0x81, 0x81, 0x81, 0x80, 0x80},
  {0x20, 0x81, 0x81, 0x80, 0x80, 0x80},
  {0x20, 0x00, 0x83, 0x00, 0x88, 0x80},
  {0x00, 0x00, 0x83, 0x23, 0x88, 0x80},
  {0x80, 0x21, 0x02, 0x84, 0x00, 0x90},
  {0x20, 0x81, 0x00, 0x84, 0x80, 0x80},
  {0x80, 0x21, 0x02, 0x84, 0x80, 0x80},
  {0x20, 0x81, 0x80, 0x80, 0x80, 0x80}, //31 = 7 DX11
  {0xA0, 0x80, 0x80, 0x80, 0x80, 0x80}, //32 = 8 DX11
#ifdef OPSIX
  {0x20, 0x00, 0x00, 0x04, 0x0B, 0x90},
  {0x21, 0x01, 0x02, 0x04, 0x08, 0x90},
  {0x20, 0x00, 0x83, 0x00, 0x00, 0x98},
  {0x20, 0x00, 0x00, 0x00, 0x8F, 0x8F},
  {0x20, 0x01, 0x00, 0x04, 0x82, 0x88},
  {0x20, 0x80, 0x00, 0x00, 0x8C, 0x8C},
  {0x20, 0x00, 0x83, 0x83, 0x83, 0x83},
  {0x20, 0x01, 0x82, 0x82, 0x82, 0x82},
#ifdef SY77
  {0x00, 0x01, 0x02, 0x04, 0x08, 0x90},
  {0x00, 0x00, 0x03, 0x04, 0x08, 0x90},
  {0x00, 0x00, 0x02, 0x05, 0x08, 0x90},
  {0x00, 0x00, 0x02, 0x04, 0x09, 0x90},
  {0x00, 0x01, 0x02, 0x04, 0x08, 0x91},
  {0x00, 0x00, 0x00, 0x07, 0x08, 0x90},
  {0x00, 0x01, 0x00, 0x04, 0x0A, 0x90},
  {0x00, 0x00, 0x00, 0x04, 0x0B, 0x90},
  {0x00, 0x00, 0x03, 0x00, 0x0C, 0x90},
  {0x00, 0x01, 0x00, 0x04, 0x08, 0x92},
  {0x00, 0x00, 0x00, 0x04, 0x08, 0x93},
  {0x00, 0x00, 0x03, 0x04, 0x00, 0x98},
  {0x00, 0x00, 0x02, 0x05, 0x00, 0x98},
  {0x00, 0x00, 0x00, 0x00, 0x0F, 0x90},
  {0x00, 0x00, 0x00, 0x07, 0x00, 0x98},
  {0x00, 0x00, 0x02, 0x00, 0x08, 0x95},
  {0x00, 0x00, 0x03, 0x00, 0x08, 0x94},
  {0x00, 0x00, 0x00, 0x00, 0x08, 0x97},
  {0x20, 0x00, 0x00, 0x00, 0x09, 0x96},
  {0x00, 0x00, 0x00, 0x00, 0x00, 0x9F},
  {0x00, 0x01, 0x02, 0x04, 0x88, 0x80},
  {0x00, 0x00, 0x03, 0x04, 0x88, 0x80},
  {0x00, 0x00, 0x02, 0x05, 0x88, 0x80},
  {0x00, 0x00, 0x02, 0x04, 0x89, 0x80},
  {0x00, 0x00, 0x00, 0x07, 0x88, 0x80},
  {0x00, 0x01, 0x00, 0x03, 0x8A, 0x80},
  {0x00, 0x00, 0x00, 0x04, 0x8B, 0x80},
  {0x00, 0x00, 0x03, 0x00, 0x8C, 0x80},
  {0x00, 0x00, 0x00, 0x00, 0x8F, 0x80},
  {0x00, 0x01, 0x02, 0x84, 0x00, 0x90},
  {0x00, 0x21, 0x03, 0x84, 0x00, 0x90},
  {0x00, 0x00, 0x03, 0x85, 0x00, 0x90},
  {0x00, 0x00, 0x00, 0x87, 0x00, 0x90},
  {0x00, 0x01, 0x82, 0x00, 0x08, 0x90},
  {0x00, 0x00, 0x83, 0x00, 0x08, 0x90},
  {0x00, 0x00, 0x83, 0x23, 0x00, 0x98},
  {0x00, 0x01, 0x02, 0x84, 0x80, 0x80},
  {0x00, 0x00, 0x03, 0x84, 0x80, 0x80},
  {0x00, 0x00, 0x02, 0x85, 0x80, 0x80},
  {0x00, 0x01, 0x82, 0x23, 0x88, 0x88},
  {0x00, 0x00, 0x83, 0x23, 0x88, 0x88}, //41 = 20 DX7
  {0x20, 0x81, 0x00, 0x84, 0x00, 0x90},
  {0x21, 0x01, 0x83, 0x83, 0x83, 0x83},
  {0x20, 0x81, 0x81, 0x81, 0x81, 0x81},
